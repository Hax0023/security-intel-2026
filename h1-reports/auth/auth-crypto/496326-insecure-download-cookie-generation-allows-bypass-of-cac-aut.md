...
## Metadata
- **Source:** HackerOne
- **Report:** 496326 | https://hackerone.com/reports/496326
...
If an attacker can generate this cookie, this allows downloading a file. As it turns out, the generation of the cookie is fairly straightforward and requires no server-side key, only a file
