...
## Metadata
- **Source:** HackerOne
- **Report:** 136169 | https://hackerone.com/reports/136169
...
#Overview#
The *.uber.com WordPress sites use OneLogin SAML-SSO instead of the normal WordPress login. The WordPress plugin shipped by OneLogin has a bug which allows anyone to login without a password or oth
