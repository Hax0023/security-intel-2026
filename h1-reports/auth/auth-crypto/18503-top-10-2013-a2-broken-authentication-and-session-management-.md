...
## Metadata
- **Source:** HackerOne
- **Report:** 18503 | https://hackerone.com/reports/18503
...
7- request is approved and validated because the old session is still valid in server side and is not invalidated prope
