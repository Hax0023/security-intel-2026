...
## Metadata
- **Source:** HackerOne
- **Report:** 126522 | https://hackerone.com/reports/126522
...
#Detail
Digits web authentication has strict validation on *host* and *callback_url*. On the server side, the values are compared with the registered domain. However, on the client side, the way parameters are parsed has a wrong assump
