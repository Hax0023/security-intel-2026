...
## Metadata
- **Source:** HackerOne
- **Report:** 2337427 | https://hackerone.com/reports/2337427
...
In this instance, vulnerability was result of the default enabled PreSignedURL, which incorrectly checks the expiry date in `OC-Date` and `OC-Expires` variables. If the date has ex
