...
## Metadata
- **Source:** HackerOne
- **Report:** 1245762 | https://hackerone.com/reports/1245762
...
2. A session for the user is created and a session token is returned, but no operations with this session are possible until the veri
