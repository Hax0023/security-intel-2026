...
## Metadata
- **Source:** HackerOne
- **Report:** 2800511 | https://hackerone.com/reports/2800511
- **Submitted:** 2024-10-24
- **Reporter:** xendaviour
- **Program:** Unknown
- **Bounty:** Not disclosed
- **Severity:** medium
- **Vuln:** Reusing Session IDs (aka Session Replay)
- **CVEs:** None
...
**Summary:** [AWS SSO allows re-access to the AWS Access Portal without re-authentication after a session timeou
