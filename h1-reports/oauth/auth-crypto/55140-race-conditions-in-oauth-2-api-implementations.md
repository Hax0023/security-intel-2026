...
## Metadata
- **Source:** HackerOne
- **Report:** 55140 | https://hackerone.com/reports/55140
...
Exploitation for `refresh_token` is more dangerous than for `access_token`, because there is no way for an attacker to fail. Each exploitation gives at least one new `refresh_token` which may be used further. Thus, number of token pairs grows exponenti
