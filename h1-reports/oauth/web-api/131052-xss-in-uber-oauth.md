...
## Metadata
- **Source:** HackerOne
- **Report:** 131052 | https://hackerone.com/reports/131052
...
Although the redirecting is done through `location` header , there still some cases in which this can be harmful to users a
