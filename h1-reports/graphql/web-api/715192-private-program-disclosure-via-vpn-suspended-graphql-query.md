...
## Metadata
- **Source:** HackerOne
- **Report:** 715192 | https://hackerone.com/reports/715192
- **Submitted:** 2019-10-16
- **Reporter:** unknown_person
- **Program:** Unknown
- **Bounty:** $2,500
- **Severity:** none
...
If an external program (which also has private program) has enabled VPN , then value of vpn_suspended 
