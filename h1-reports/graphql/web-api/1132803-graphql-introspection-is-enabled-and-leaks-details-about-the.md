...
## Metadata
- **Source:** HackerOne
- **Report:** 1132803 | https://hackerone.com/reports/1132803
- **Submitted:** 2021-03-23
- **Reporter:** sahil__soni
- **Program:** Unknown
...
## Summary
## Summary:
Hi team ! i've found a misconfiguration in your graphql Api on the endpoint https://www.on-running.com/en-in/graphql in which an attacker is able to run a graphql interospection query to fetch schemas , types , fields , available query operations  , after running interospection query on the graphql api endpoint  , an attacker is able to list all type of available api calls , so he'll b
