...
## Metadata
- **Source:** HackerOne
- **Report:** 3467641 | https://hackerone.com/reports/3467641
...
## Description
While testing the application at fizzy.do domain asset into https://app.fizzy.do/ subdomain file uploads, I noticed that files and file previews served through Active Storage can be accessed directly via their URLs, without any authentication or authorization checks. These URLs remain accessible t
...
The issue does not require guessing or brute-forcing URLs.
The application exposes these URLs during normal usage (e.g., in HTML markup and browser requests).
The same behavior was observed across multiple file types, including PDFs, images, text files, and HTML files.
