...
## Metadata
- **Source:** HackerOne
- **Report:** 214798 | https://hackerone.com/reports/214798
...
**Description:**
By inserting a single quote after the `1` in the `string:1` value of the `c0-param0` parameter I received an Oracle SQL error. Using the
