...
## Metadata
- **Source:** HackerOne
- **Report:** 674838 | https://hackerone.com/reports/674838
...
The above url has a form where the field MSI_queryType is vulnerable to time based blind SQL injection. I verified that sqlmap could identify the DBMS, and if the account had DBA rights. No other 
