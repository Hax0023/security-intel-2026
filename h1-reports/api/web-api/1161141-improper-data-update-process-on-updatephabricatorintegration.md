...
## Metadata
- **Source:** HackerOne
- **Report:** 1161141 | https://hackerone.com/reports/1161141
...
## Introduction
Sensitive data exposure occurs when an application, company, or other entity inadver
...
6. Update **Phabricator** integration and intercept the request, add following to the GraphQL query: `"base_url":"https://yourcol
