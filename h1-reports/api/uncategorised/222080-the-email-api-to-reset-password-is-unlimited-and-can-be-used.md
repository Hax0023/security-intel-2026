...
## Metadata
- **Source:** HackerOne
- **Report:** 222080 | https://hackerone.com/reports/222080
...
2.then I try to visit one `https://demo.nextcloud.com/qazxsw/login?user=admin`,then I try to login it using `user
