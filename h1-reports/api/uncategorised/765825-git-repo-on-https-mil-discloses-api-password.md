...
## Metadata
- **Source:** HackerOne
- **Report:** 765825 | https://hackerone.com/reports/765825
- **Submitted:** 2019-12-29
- **Reporter:** al-madjus
- **Program:** Unknown
- **Bounty:** Not disclosed
- **Severity:** high
- **Vuln:** Password in Configuration File
- **CVEs:** None
...
**Description:**
Fetching the git repository and decompressing the objects results in the ability to read the source code of the server, which includes an API password for the Yubikey hardware authentication software. The API howev
