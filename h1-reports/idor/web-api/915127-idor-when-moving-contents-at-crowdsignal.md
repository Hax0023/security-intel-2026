...
## Metadata
- **Source:** HackerOne
- **Report:** 915127 | https://hackerone.com/reports/915127
...
`actionable[]` parameter's value is the content's ID. And if you change this ID to victim's content ID, you will see victim's content at `My Content` page. But you can't see re
