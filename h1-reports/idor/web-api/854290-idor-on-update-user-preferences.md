...
## Metadata
- **Source:** HackerOne
- **Report:** 854290 | https://hackerone.com/reports/854290
...
## Steps To Reproduce:
  ...
  2. Login in as user2, open Mail tab and select user1 from `Conversation assignment` dropdown (see F796149 attachmen
