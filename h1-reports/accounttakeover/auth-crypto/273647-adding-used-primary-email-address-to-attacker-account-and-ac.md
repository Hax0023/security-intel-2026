...
## Metadata
- **Source:** HackerOne
- **Report:** 273647 | https://hackerone.com/reports/273647
...
I was looking at the source code of the application and I found that, "If the email address `test@test.com` is already added in the `X` Gratipay account as primary email address, then the attacker can also add the `test@test.com` i
