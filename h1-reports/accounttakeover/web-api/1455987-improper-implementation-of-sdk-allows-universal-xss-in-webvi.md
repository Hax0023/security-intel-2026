...
## Metadata
- **Source:** HackerOne
- **Report:** 1455987 | https://hackerone.com/reports/1455987
...
# Summary:
The **SurveyMonkey** SDK, used to collect surveys from users for analytic and informative purposes, was implemented in an insecure manner in . Particularly, the `SMFeedbackActivity` was exported, allowing any app installed on user's device to launch it. In the implementation 
