...
## Metadata
- **Source:** HackerOne
- **Report:** 1923672 | https://hackerone.com/reports/1923672
...
* there is open redirect while loggin to gitlab Via SAML, while the Open redirect is not much impactful since it is a post based request coming from third party domain, but the red
