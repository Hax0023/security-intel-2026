...
## Metadata
- **Source:** HackerOne
- **Report:** 855618 | https://hackerone.com/reports/855618
...
When trying to login with Arrive app the user needs to request a login email to continue the login process. The user recei
