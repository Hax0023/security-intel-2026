...
## Metadata
- **Source:** HackerOne
- **Report:** 369451 | https://hackerone.com/reports/369451
...
**Summary:** 
During the first run, the CI pipeline seems to defend against SSRF properly, however when a build is re-run a second time
