...
## Metadata
- **Source:** HackerOne
- **Report:** 2493548 | https://hackerone.com/reports/2493548
...
- **Severity:** critical
- **Vuln:** Type Confusion
- **CVEs:** CVE-2023-24329, CVE-2024-22243
- **Category:** web-api
...
[RFC 4291](https://datatracker.ietf.org/doc/html/rfc4291#section-2-5-5) defines ways to embed an IPv4 address into IPv6 addresses. One of the methods defined in the RFC is to use IPv4-mappe
