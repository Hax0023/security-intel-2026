...
## Metadata
- **Source:** HackerOne
- **Report:** 1220688 | https://hackerone.com/reports/1220688
...
What is SSRF?
Server-side request forgery (also known as SSRF) is a web security vulnerability that allows an attacker to induce the server-side application to make HTTP requests to an arbitrary domain of the attacker's c
