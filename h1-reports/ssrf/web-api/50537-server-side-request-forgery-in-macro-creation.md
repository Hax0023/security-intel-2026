...
## Metadata
- **Source:** HackerOne
- **Report:** 50537 | https://hackerone.com/reports/50537
...
SSRF is a vulnerability allowing requests to be made from the context of the server. This could allow an attacker to gain access to previously unknown data, and potentially also cause malicious access on services pre
