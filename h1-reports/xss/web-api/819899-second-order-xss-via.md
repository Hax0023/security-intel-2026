...
## Metadata
- **Source:** HackerOne
- **Report:** 819899 | https://hackerone.com/reports/819899
...
**Description:**
This will send an e-mail to the user that they have received a new message, and the malicious message will be sent to the user without first being sanitized. This allows the malicious user to inject HTML via the e
