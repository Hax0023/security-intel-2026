...
## Metadata
- **Source:** HackerOne
- **Report:** 351554 | https://hackerone.com/reports/351554
...
**Description:**
I'd like to first point out that this is no longer vulnerable, but I filed a report anyways since it was never discovered. It looks like this was fixed on "accident". Originally, JS was rendering the username via a ".html()" jquery method, but was refactored to ".tex
