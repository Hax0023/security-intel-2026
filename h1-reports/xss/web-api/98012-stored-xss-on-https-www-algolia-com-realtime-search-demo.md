...
## Metadata
- **Source:** HackerOne
- **Report:** 98012 | https://hackerone.com/reports/98012
...
There is a protection by CloudFlare, but because the values of the Attributes are printed in Javascript code, I found a way to abuse this to execute Javascript code.  Seems like ClodFlare is a little more permissive when the malicious code is in the name of the parameter
