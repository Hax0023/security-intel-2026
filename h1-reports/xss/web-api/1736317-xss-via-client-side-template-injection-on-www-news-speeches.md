...
## Metadata
- **Source:** HackerOne
- **Report:** 1736317 | https://hackerone.com/reports/1736317
...
Furthermore the frontend of the website is presumably created with a template engine. These engines handle user supplied data within double curly braces `{{...}}` for example. 
