...
## Metadata
- **Source:** HackerOne
- **Report:** 1955370 | https://hackerone.com/reports/1955370
...
### Description
Downstream parsing of values sent to the redirect_to function will cause the 'location' header to be removed from the response when cer
