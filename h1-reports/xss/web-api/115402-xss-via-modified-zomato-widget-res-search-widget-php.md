...
## Metadata
- **Source:** HackerOne
- **Report:** 115402 | https://hackerone.com/reports/115402
...
An attacker can create a web page that includes a Zomato widget inside an iframe with a specially crafted URL parameter that contains javas
