...
## Metadata
- **Source:** HackerOne
- **Report:** 247517 | https://hackerone.com/reports/247517
...
There is __Stored XSS__ vulnerability in Private Messages 'Reply' feature, when original message is quoted in reply content (this is by default). This issue can be used against any use
