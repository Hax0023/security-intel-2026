...
## Metadata
- **Source:** HackerOne
- **Report:** 1085336 | https://hackerone.com/reports/1085336
...
By changing the value of  `type` in the URL above, from `SNAPCODE` to `SNAPCODE_NO_PROMPT`, we can bypass the prompt mentioned
