...
## Metadata
- **Source:** HackerOne
- **Report:** 141065 | https://hackerone.com/reports/141065
...
CSRF Token's are different from session ID'S in a way that they are not consistent in entire user session but drchrono.com do not practice the rotat
