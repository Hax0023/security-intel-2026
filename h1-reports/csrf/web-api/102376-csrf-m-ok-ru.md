...
## Metadata
- **Source:** HackerOne
- **Report:** 102376 | https://hackerone.com/reports/102376
...
Его можно отправить через редактирование заметки, записи в группе, при репосте и т.д Нам достаточно дать ссылку на репост и если пользователь нажмет на кноп
