...
## Metadata
- **Source:** HackerOne
- **Report:** 881855 | https://hackerone.com/reports/881855
...
Given that the method is lacking CSRF checks, an attacker could change the background image of the blog to an arbitrary one from the media library via a C
