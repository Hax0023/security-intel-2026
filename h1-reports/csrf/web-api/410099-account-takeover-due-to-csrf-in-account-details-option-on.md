...
## Metadata
- **Source:** HackerOne
- **Report:** 410099 | https://hackerone.com/reports/410099
...
**Description:**
The CSRF issue allows me to modify the datas of every victim that is targeted using the CSRF file, and leading to account takeover simply setting my email as email of the victim: logging out I can recover the password of the
