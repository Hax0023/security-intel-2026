...
## Metadata
- **Source:** HackerOne
- **Report:** 513137 | https://hackerone.com/reports/513137
...
Issue background ==>
Cross-site Request Forgery (CSRF) is an attack which forces an end user to execute unwanted actions on a web application to which he/she is currently authenticated. With a little help of social engineering (like sen
